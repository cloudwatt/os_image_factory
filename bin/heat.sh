...
heat stack-create ${NAME} -f os_image_factory.heat.yml -P OS_USERNAME=${OS_USERNAME} -P OS_PASSWORD=${OS_PASSWORD} -P OS_TENANT_NAME=${OS_TENANT_NAME} -P keypair_name=${KEYPAIR}
